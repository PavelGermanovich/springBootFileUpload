...
import com.example.springboot.message.ResponseFile;
import com.example.springboot.message.ResponseMessage;
import com.example.springboot.model.FileDb;
import com.example.springboot.service.DbStorageService;
...
@Controller
@RequestMapping("/db")
public class FileUploadControllerUsingDb {
    @Autowired
    DbStorageService storageService;
    ...
    public ResponseEntity<List<ResponseFile>> getListFiles() {
        List<ResponseFile> responseFiles = storageService.getAllFiles().map(dbFile -> {
